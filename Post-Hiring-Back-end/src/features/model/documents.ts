...
async function listOneDocuments(document_id: number) {

    const sql = `select * from documents as doc left join sector as sec on sec.sector_id = doc.sector_id where document_id = $1;`
...
module.exports = { listAllDocuments, insertDocuments, deleteDocuments, updateDocuments, listOneDocuments }